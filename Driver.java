...
public class Driver
{
    ...
    public ArrayList Recurse(ArrayList<Athlete> list)
    {
        ...
        if(list.size()==0)
        {
        masterRecurseList.add(rCheated);
        masterRecurseList.add(rDidNotCheat);
        masterRecurseList.add(rGold);
        masterRecurseList.add(rSilver);
        masterRecurseList.add(rBronze);
        masterRecurseList.add(rOneMedal);
        masterRecurseList.add(rNoMedals);
        masterRecurseList.add(rAquatic);
        masterRecurseList.add(rTrack);
        masterRecurseList.add(rGym);
        masterRecurseList.add(rOutdoor);
        System.out.println(masterRecurseList);
        }
    }
}
